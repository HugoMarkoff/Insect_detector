...
| **Camera** (Pi V2 **or** V3 — same 25 × 24 board, 21 × 12.5 holes) | **Flush in a 1.2 mm floor pocket** inside the board slot, located by **four printed pins** (Ø1.8 in its 2.2 mm holes) | Only the **sensor housing pokes out** through a 13 mm square cutout (passes the bulky Module 3 housing), with a wide offset slot that swallows both the V3 ribbon and V2's L-shaped flex; a shallow trench lets the main FFC cable lie flat |
| **Main trap PCB** (82 × 40, holes 58 × 23 — exact from its PcbDoc) | Across the body on short rigid 6 mm × Ø7 posts | Upper posts stand in the camera slot, lower ones below the board's bottom edge; the **Pi Zero stacks onto the trap PCB's own 58 × 23 pattern** |
